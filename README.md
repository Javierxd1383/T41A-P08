...
Se utilicen con frecuencia en las cláusulas WHERE, JOIN y ORDER BY.

Tengan alta selectividad (pocos valores repetidos, ej. un DNI o un código de producto).

Sean Claves Foráneas (FKs) para optimizar las operaciones de unión (JOIN).
